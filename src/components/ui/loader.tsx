...
export default function Loader({ children }: LoaderProps) {
    ...
    useEffect(() => {
        ...
        const paths = svgRef.current.querySelectorAll<
            SVGPathElement | SVGPolylineElement
        >("path, polyline");
        ...
        const timer = setTimeout(() => {
            ...
            // Reset scroll position to top (prevents jump)
    ...
    return (
        <>
            ...
            {/* Children appear only after loading */}
            <motion.div
                initial={{ opacity: 0 }}
